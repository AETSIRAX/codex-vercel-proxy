...
const CORS_HEADERS = {
  ...
  "Access-Control-Allow-Headers":
    "authorization,content-type,x-api-key,x-client-request-id,session-id,thread-id,x-codex-turn-state,x-codex-turn-metadata,x-codex-window-id,x-codex-beta-features,originator,version",
